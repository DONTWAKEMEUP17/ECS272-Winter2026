...
function initChart() {
    ...
    const minPop = d3.min(data.value, d => d.avg_popularity) as number
    const maxPop = d3.max(data.value, d => d.avg_popularity) as number
